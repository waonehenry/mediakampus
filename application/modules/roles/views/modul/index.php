                        ...
                        <div class="col-md-6">
                            ...
                            <div class="portlet light ">
                                ...
                                <div class="portlet-body form">
                                    <!-- BEGIN FORM-->
                                    <form action="<?php echo base_url ('roles/modul/store')?>" class="form-horizontal form-input" id="">
                                        <div class="form-body">
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Label</label>
                                                <div class="col-md-9">
                                                    <input type="text" name="data[label_modul]" id="label" class="form-control input-type input-text first-focus" required placeholder="Enter text">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                      <div class="input-group">
                                                            <select class="form-control input-type input-text" name="data[class]" id="child">
                                                                <option value="">----- Silakan pilih -----</option>
                                                                <option value="has-no-sub">Tidak Punya</option>
                                                                <option value="has-sub">Punya</option>
                                                            </select>
                                                      </div>
                                                </div>
                                            </div>
        ...
        $('.btn-edit').on("click", function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    $("#label").val(response.label_modul);
                    $("#child").val(response.class);
