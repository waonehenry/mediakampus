<div id="page-wrapper" style="">
        ...
        <div class="col-lg-6">
             <div class="card">
               ...
               <div class="card-content">
                 ...
                 <form class="col s12 form-input" method="post" action="<?= base_url()?>schedule/empty_course/store">
                   <div class="row">
                     <div class="input-field col s12">
                       <input id="date" type="text" name="data[date_start]" required class="input-text input-date" autocomplete="off">
                   ...
                   <div class="row">
                     <div class="col s12">
                        <?php foreach ($shift->result() as $key): ?>
                            <p>
                              <input type="checkbox" class="filled-in input-text-checkbox" id="filled-in-box-<?= $key->id ?>" value="<?= $key->id ?>" name="data[shift_start][]"/>
   ...
   $(document).ready(function() {
        ...
        $(".menu-empty-course").addClass('active-menu');
       ...
       table = $('#table-content').DataTable({
           ...
           "ajax": {
               "url": "<?php echo site_url('schedule/empty_course/server_side_list')?>",
               "type": "POST"
           },
