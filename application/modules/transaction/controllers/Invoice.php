...
class Invoice extends MX_Controller {
	...
	{
			$data['page'] = 'transaction/invoice/index';
	...
	public function delete($id)
	{
			...
			$result = $this->Invoice_model->delete($data, $id);
			if ($result)
			{
				$response['status'] = 'success';
          ...
          $row[] = $field->dana.' '.$field->tahun_anggaran;
					$row[] = '<div class="btn-group pull-right">
							...
							<ul class="dropdown-menu pull-right">
									<li>
											<a href="'.base_url().'transaction/invoice/edit/'.$field->id.'" class="btn-edit">
													<i class="fa fa-pencil"></i> Edit </a>
									</li>
									<li>
											<a href="'.base_url().'transaction/invoice/detail/'.$field->id.'" class="btn-detail">
													<i class="fa fa-list"></i> Detail </a>
									</li>
									<li>
											<a href="'.base_url().'transaction/invoice/delete/'.$field->id.'" class="btn-delete">
