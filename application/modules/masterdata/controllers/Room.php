...
class Room extends MX_Controller {
	...
	{
			$data['page'] = 'masterdata/room/index';
			$data['title'] = 'Room';
	...
	public function store()
	{
			...
			$result = $this->Room_model->insert($data);
			if ($result)
			{
	...
	{
			$where['id'] = $id;
			$data = $this->Room_model->get_data_by($where)->row_array();
	...
	public function update($id)
	{
			...
			$result = $this->Room_model->update($data, $id);
			if ($result)
			{
				$response['status'] = 'success';
	...
	public function delete($id)
	{
			...
			$result = $this->Room_model->delete($data, $id);
			if ($result)
			{
				$response['status'] = 'success';
          ...
          $row[] = $field->description;
					$row[] = '<div class="btn-group">
							...
							<ul class="dropdown-menu pull-right">
									<li>
											<a href="'.base_url().'masterdata/room/edit/'.$field->id.'" class="btn-edit">
													<i class="fa fa-pencil"></i> Edit </a>
									</li>
									<li>
											<a href="'.base_url().'masterdata/room/delete/'.$field->id.'" class="btn-delete">
