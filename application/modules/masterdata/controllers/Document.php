...
class Document extends MX_Controller {
	...
	{
			$data['page'] = 'masterdata/document/index';
			$data['title'] = 'Document';
	...
	{
			$where['ref_document.id'] = $id;
			$data = $this->Document_model->get_data_by($where)->row_array();
	...
	public function update($id)
	{
			...
			$result = $this->Document_model->update($data, $id);
			if ($result)
			{
				$response['status'] = 'success';
	...
	public function delete($id)
	{
			...
			$result = $this->Document_model->delete($data, $id);
			if ($result)
			{
				$response['status'] = 'success';
          ...
          $row[] = $field->code;
					...
					$row[] = '<div class="btn-group">
							...
							<ul class="dropdown-menu pull-right">
									<li>
											<a href="'.base_url().'masterdata/document/edit/'.$field->id.'" class="btn-edit">
													<i class="fa fa-pencil"></i> Edit </a>
									</li>
									<li>
											<a href="'.base_url().'masterdata/document/delete/'.$field->id.'" class="btn-delete">
