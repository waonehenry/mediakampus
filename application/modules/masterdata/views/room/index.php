<div id="page-wrapper" style="">
        ...
        <div class="col-lg-6">
             <div class="card">
               ...
               <div class="card-content">
                 ...
                 <form class="col s12 form-input" method="post" action="<?= base_url()?>masterdata/room/store">
                   <div class="row">
   ...
   $(document).ready(function() {
       ...
       $(".menu-room").addClass('active-menu');

       var default_url = '<?= base_url()?>masterdata/room/store';
       //datatables
       table = $('#table-content').DataTable({
           ...
           "ajax": {
               "url": "<?php echo site_url('masterdata/room/server_side_list')?>",
               "type": "POST"
           },
