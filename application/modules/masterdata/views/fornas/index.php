                        ...
                        <div class="col-md-6" style="display: none;">
                            ...
                            <div class="portlet light ">
                                ...
                                <div class="portlet-body form">
                                    <!-- BEGIN FORM-->
                                    <form action="<?php echo base_url ('masterdata/fornas/store')?>" class="form-horizontal form-input" id="">
                                        <div class="form-body">
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Code</label>
                                                <div class="col-md-9">
                                                  <textarea name="data[id_fornas]" row="3" id="description" class="form-control input-text"></textarea>
                                              </div>
                                          </div>
                                          <div class="form-group">
                                            <label class="col-md-3 control-label">Name</label>
                                            <div class="col-md-9">
                                                <input type="text" name="data[nama_obat]" id="name" autocomplete="off" class="form-control input-type input-text first-focus" required placeholder="Enter text">
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        var default_url = '<?= base_url()?>masterdata/fornas/store';
    //datatables
    table = $('#table-content').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('masterdata/fornas/server_side_list')?>",
            "type": "POST"
        },
