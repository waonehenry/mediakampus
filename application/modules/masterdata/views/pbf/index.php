                        ...
                        <div class="col-md-6" style="display: none;">
                            ...
                            <div class="portlet light ">
                                ...
                                <div class="portlet-body form">
                                    <!-- BEGIN FORM-->
                                    <form action="<?php echo base_url ('masterdata/pbf/store')?>" class="form-horizontal form-input" id="">
                                        <div class="form-body">
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Name</label>
                                                <div class="col-md-9">
                                                    <input type="text" name="data[SuplierName]" id="name" autocomplete="off" class="form-control input-type input-text first-focus" required placeholder="Enter text">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Telepon</label>
                                                <div class="col-md-9">
                                                  <textarea name="data[Telpon]" row="3" id="description" class="form-control input-text"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Address</label>
                                                <div class="col-md-9">
                                                  <textarea name="data[alamat]" row="3" id="description" class="form-control input-text"></textarea>
                                                </div>
                                            </div>
                                        </div>
...
$(document).ready(function() {
    var default_url = '<?= base_url()?>masterdata/pbf/store';
    //datatables
    table = $('#table-content').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('masterdata/pbf/server_side_list')?>",
            "type": "POST"
        },
