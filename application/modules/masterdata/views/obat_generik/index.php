                        ...
                        <div class="col-md-6" style="display: none;">
                            ...
                            <div class="portlet light ">
                                ...
                                <div class="portlet-body form">
                                    <!-- BEGIN FORM-->
                                    <form action="<?php echo base_url ('masterdata/obat_generik/store')?>" class="form-horizontal form-input" id="">
                                        <div class="form-body">
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Name</label>
                                                <div class="col-md-9">
                                                    <input type="text" name="data[nama_zat]" id="name" autocomplete="off" class="form-control input-type input-text first-focus" required placeholder="Enter text">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Program</label>
                                                <div class="col-md-9">
                                                  <textarea name="data[program]" row="3" id="description" class="form-control input-text"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="table-content">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="min-tablet">Program</th>
                                                <!-- <th class="all">Act</th> -->
                                            </tr>
                                        </thead>
                                        <tbody></tbody>
...
$(document).ready(function() {
    var default_url = '<?= base_url()?>masterdata/obat_generik/store';
    //datatables
    table = $('#table-content').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('masterdata/obat_generik/server_side_list')?>",
            "type": "POST"
        },
