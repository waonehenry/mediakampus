                        ...
                        <div class="col-md-6" style="display: none;">
                            ...
                            <div class="portlet light ">
                                ...
                                <div class="portlet-body form">
                                    <!-- BEGIN FORM-->
                                    <form action="<?php echo base_url ('masterdata/program/store')?>" class="form-horizontal form-input" id="">
                                        <div class="form-body">
...
$(document).ready(function() {
    var default_url = '<?= base_url()?>masterdata/program/store';
    //datatables
    table = $('#table-content').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('masterdata/program/server_side_list')?>",
            "type": "POST"
        },
