...
class Info extends MX_Controller {
	...
	function __construct()
    {
				...
				$this->type = 2; // for information
    }

	public function index()
	{
			$data['page'] = 'agenda/info/index';
          ...
          $row[] = $field->date_start.'-'.$field->date_end;
					$row[] = '<div class="btn-group">
							...
							<ul class="dropdown-menu pull-right">
									<li>
											<a href="'.base_url().'agenda/info/edit/'.$field->id.'" class="btn-edit">
													<i class="fa fa-pencil"></i> Edit </a>
									</li>
									<li>
											<a href="'.base_url().'agenda/info/delete/'.$field->id.'" class="btn-delete">
